...
from .table_functions.tf_fits_asciitable_header import _read_TFORM_condition, _read_TFORM_body
from .table_functions.tf_fits_asciitable_data import _asciitable_column_condition, _asciitable_column_body
...
def asciitable_decode_fits(fits_data, header=1):
    ...
    col_loop = tf.while_loop(_asciitable_column_condition, _asciitable_column_body,
